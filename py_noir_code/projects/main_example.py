...
from py_noir_code.projects.Comete_T2STIR.comete_moelle_json_generator import generate_comete_moelle_json
...
if __name__ == '__main__':
    ...
    if not os.path.exists(json_save_path + json_file_name):
        executions = init_executions(json_file_path + json_file_name, generate_comete_moelle_json())
    else:
        executions = resume_executions(json_file_path, json_save_path, json_file_name)
